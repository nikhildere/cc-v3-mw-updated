...
namespace Microsoft.Teams.Apps.CompanyCommunicator.Common.Repositories
{
        ...
        where T : TableEntity, new()
    {
        ...
        /// <summary>
        /// Get filtered data entities by messageID from the table storage.
        /// </summary>
        /// <param name="messageId">equal to messageId</param>
        /// <returns>Filtered data entities.</returns>
        public Task<T> GetAllEqualToMessageIDAsync(string messageId);
