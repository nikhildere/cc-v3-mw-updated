...
namespace Microsoft.Teams.Apps.CompanyCommunicator.Common.Repositories.SentNotificationData
{
    ...
    public class SentNotificationDataEntity : TableEntity
    {
        ...
        /// <summary>
        /// Gets or sets a value indicating whether any button(s) was clicked by the user.
        /// </summary>
        public bool ClickStatus { get; set; }

        /// <summary>
        /// Gets or sets a value indicating when any button was first clicked by the user.
        /// </summary>
