    ...
    public class SyncTeamMembersActivity
    {
            ...
            ILogger log)
        {
            ...
            try
            {
                ...
                {
                    log.LogInformation("Tanya, check here for user Entity" + ue.UserId);
                }*/
                ...
                log.LogInformation("Tanya, chcek here" + recipients.AsEnumerable<SentNotificationDataRepository>()); */
                // Store.
            ...
            catch (Exception ex)
            {
                ...
                log.LogInformation("Techie, check - Stack Trace");
                var messagestr = "";
                if (ex.StackTrace.Length > 0)
                {
                    messagestr += ex.StackTrace;
                }
                log.LogInformation(messagestr);
                log.LogInformation("Techie, check - Inner Exception");
