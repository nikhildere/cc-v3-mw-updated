...
// </copyright>
// Added : changes to add sender on behalf of Author in messageActivity Object.
...
namespace Microsoft.Teams.Apps.CompanyCommunicator.Send.Func
{
    ...
    public class SendFunction
    {
        ...
        private async Task<IMessageActivity> GetMessageActivity(SendQueueMessageContent message, ILogger log)
        {
            ...
            {
                var uniqueUser = message.RecipientData.RecipientId;
                jsonAC = jsonAC.Replace("[NotificationID]", message.NotificationId);
                jsonAC = jsonAC.Replace("[UserID]", uniqueUser);
            }
            ...
            // Added: to add send on behalf of user in teams message.
