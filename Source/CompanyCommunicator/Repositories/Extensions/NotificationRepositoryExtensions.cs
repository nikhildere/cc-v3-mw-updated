...
namespace Microsoft.Teams.Apps.CompanyCommunicator.Repositories.Extensions
{
    ...
    {
        // Added: If app setting with ImageUploadBlobStoarge is set to true or false.
        ...
        /// <param name="isImageUploadBlobStorage">Bool indicates if App settings named ImageUploadBlobStoarge is true or false.</param>
            ...
            string userName)
        {
            ...
            var notificationEntity = new NotificationDataEntity
            {
                ...
                ClickRateUrl = notification.ClickRateUrl,
            ...
            if (isImageUploadBlobStorage && !string.IsNullOrEmpty(notification.ImageLink) && notification.ImageLink.StartsWith(Constants.ImageBase64Format))
            {
